...
/*
Implement a game rest functionality, so that the plaer can make a new guess! Here is how:

1. Select the element with the 'again' class and attach a click event handler.
2. In the handler function, restore intitial values of the score and number variables.
3. Resotre the initial conditions of the message, number, score and guess input field.
